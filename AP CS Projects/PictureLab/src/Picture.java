...
public class Picture extends SimplePicture
{
  ...
  {
    String output =
      "Picture, filename " + getFileName() + " height " + getHeight()
        + " width " + getWidth();
    return output;
  ...
  /** Method to fix an underwater picture so that fish are easier to spot */
  ...
  /** Mirror arms of a picture of a snowman */
  public void mirrorArms()
  {
    ...
    int mirrorPoint2 = 204;
    Pixel topPixel2 = null;
    Pixel bottomPixel2 = null;

    for (int row = 166; row < mirrorPoint2; row++)
    {
  ...
  /** Mirror seagulls in a picture of a beach */
   ...
   *          the start col to copy to
   * @param endCol
   *          the end col to copy to
   */
  public void copySome(Picture fromPic, int startRow, int endRow, int startCol,
    int endCol)
  {
    Pixel fromPixel = null;
    Pixel toPixel = null;
  ...
  public void createCollage()
  {
    ...
    this.copySome(flower2, 0, 100, 0, 100);
    /*
